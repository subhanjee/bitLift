...
const items = [
  {
    key: "1",
    label: <div className="py-5"> <p className="text-white ">How to import Prime into Figma?</p></div>,
  ...
  {
    key: "3",
    label: <div className="py-5">  <p className="text-white">Do I need to be Figma pro?</p> </div>,
    children: <p className="text-white">{text}</p>,
  },
  {
    key: "4",
    label:  <div className="py-5"> <p className="text-white">How do I get an update of the kit? </p></div>,
    children: <p className="text-white">{text}</p>,
  },
  {
    key: "5",
